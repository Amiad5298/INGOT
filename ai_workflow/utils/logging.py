"""Logging configuration for AI Workflow.
...
Environment Variables:
    AI_WORKFLOW_LOG: Set to "true" to enable logging (default: "false")
    AI_WORKFLOW_LOG_FILE: Path to log file (default: ~/.ai-workflow.log)
"""
...
LOG_ENABLED = os.environ.get("AI_WORKFLOW_LOG", "false").lower() == "true"
LOG_FILE = Path(os.environ.get("AI_WORKFLOW_LOG_FILE", str(Path.home() / ".ai-workflow.log")))
...
def setup_logging() -> logging.Logger:
    ...
    AI_WORKFLOW_LOG is set to "true". Otherwise, uses a NullHandler
...
def log_message(message: str) -> None:
    ...
    Messages are only written to the log file if AI_WORKFLOW_LOG=true.
