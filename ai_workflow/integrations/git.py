...
from ai_workflow.utils.console import print_error, print_info, print_success, print_warning
from ai_workflow.utils.logging import log_command
...
def handle_dirty_state(context: str, action: DirtyStateAction) -> bool:
    ...
    if action == DirtyStateAction.STASH:
        stash_msg = f"ai-workflow: auto-stash before {context}"
