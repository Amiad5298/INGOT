"""Interactive menus for AI Workflow.
...
from ai_workflow.integrations.auggie import AuggieModel, list_models
from ai_workflow.integrations.git import DirtyStateAction
from ai_workflow.ui.prompts import custom_style, prompt_select
