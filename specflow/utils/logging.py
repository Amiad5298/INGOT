...
Environment Variables:
    SPECFLOW_LOG: Set to "true" to enable logging (default: "false")
    SPECFLOW_LOG_FILE: Path to log file (default: ~/.specflow.log)
"""
...
LOG_ENABLED = os.environ.get("SPECFLOW_LOG", "false").lower() == "true"
LOG_FILE = Path(os.environ.get("SPECFLOW_LOG_FILE", str(Path.home() / ".specflow.log")))
