"""Tests for ai_workflow.utils.console module."""
...
class TestPrintFunctions:
    ...
    @patch("ai_workflow.utils.console.console_err")
    @patch("ai_workflow.utils.logging.log_message")
...
class TestBanner:
    ...
    def test_show_banner(self, mock_console):
        ...
        assert "AI" in banner_text
        assert "Workflow" in banner_text
