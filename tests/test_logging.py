"""Tests for ai_workflow.utils.logging module."""
...
class TestLogging:
    ...
    def test_log_disabled_by_default(self):
        """Logging is disabled when AI_WORKFLOW_LOG is not set."""
        with patch.dict(os.environ, {}, clear=True):
            # Need to reimport to pick up env changes
            import importlib
            import ai_workflow.utils.logging as logging_module
    ...
    def test_log_enabled_with_env_var(self):
        """Logging is enabled when AI_WORKFLOW_LOG=true."""
        with patch.dict(os.environ, {"AI_WORKFLOW_LOG": "true"}):
            import importlib
            import ai_workflow.utils.logging as logging_module
    ...
    def test_log_file_default_path(self):
        ...
        expected = Path.home() / ".ai-workflow.log"
    ...
    def test_log_file_custom_path(self):
        ...
        with patch.dict(os.environ, {"AI_WORKFLOW_LOG_FILE": custom_path}):
            import importlib
            import ai_workflow.utils.logging as logging_module
    ...
    def test_setup_logging_returns_logger(self):
        ...
        assert logger.name == "ai_workflow"
    ...
    def test_log_message_when_disabled(self):
        ...
        with patch.dict(os.environ, {"AI_WORKFLOW_LOG": "false"}):
            import importlib
            import ai_workflow.utils.logging as logging_module
    ...
    def test_log_message_when_enabled(self, tmp_path):
        ...
        with patch.dict(os.environ, {
            "AI_WORKFLOW_LOG": "true",
            "AI_WORKFLOW_LOG_FILE": str(log_file),
        }):
            import importlib
            import ai_workflow.utils.logging as logging_module
